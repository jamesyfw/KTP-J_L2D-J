...
class Block(nn.Module):
    def __init__(self, length, dim, adj, drop=0.,
        ...
        proj_drop = 0.25
        self.attn = Attention(
            dim, num_heads=self.num_heads, qkv_bias=qkv_bias, qk_scale=qk_scale,
...
class Model(nn.Module):
    def __init__(self, args):
        ...
        self.IGANet = IGANet(args.layers, args.channel, self.A, length=args.n_joints)
